...
public class Test_Case_Number_44 extends InnsightLogin{

	@AfterClass
	public void unstructureddata() throws Exception {
		String collectioname="India Modi";
