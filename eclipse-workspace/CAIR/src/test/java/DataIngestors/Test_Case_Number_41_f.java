...
public class Test_Case_Number_41_f extends InnsightLogin{
	
	@AfterClass
	public void proximity() throws Exception {
	//Test Scenario: System should support Proximity Search.
		String collectioname="Modi India";
	    ...
	    search.sendKeys("Modi AND India");
