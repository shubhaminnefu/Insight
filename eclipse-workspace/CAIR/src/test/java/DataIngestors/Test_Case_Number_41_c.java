...
public class Test_Case_Number_41_c extends InnsightLogin{
	
	//Test Scenario: System should conceptually match queries that consist of a single keyword.
