...
public class Test_Case_Number_41_d extends InnsightLogin{
	
	//Test Scenario: Phrase Occurrence Search - Uses a phrase occurrence search to find documents containing a range of occurrences of a phrase
	@AfterTest
	public void conceptually() throws Exception {
    ...
    search.sendKeys("\\\"Police Encounter\\\"");
